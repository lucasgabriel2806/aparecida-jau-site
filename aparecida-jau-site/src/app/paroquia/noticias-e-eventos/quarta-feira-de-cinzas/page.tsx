...
export const metadata: Metadata = {
  title: 'Aparecida Jaú | Quarta feira de cinzas'
}

export default function QuartaFeiraCinzas() {
  ...
  return (
    ...
    <>
      ...
      >
        ...
        <h1 className='text-2xl font-bold uppercase mt-[50px] mb-[10px]'>Modelo de notícia</h1>

        <p className='text-justify mb-[30px]'>Nesta matéria vamos contar a história de nosso começo e de como a comunidade teve um papel fundamental na construção de nossa história.</p>
        ...
        <h2 className='text-2xl font-bold uppercase mb-[10px]'>A Avenida e as Reuniões</h2>

        <p className='text-justify mb-[30px]'>Entrevistamos o Diácono Francisco Trofino que viu esta história começar e se lembra do contexto histórico desta época. A cidade estava crescendo, os bairros se ampliando, mas os meios de locomoção para a Igreja Matriz eram limitados. Logo, a comunidade de nosso bairro começou a se reunir e fazer quermesses na Avenida Frederico Ozanan, já próximo à rua Sampaio Bueno. O objetivo era angariar fundos para a construção de uma capela.</p>

        <p className='text-justify mb-[30px]'>Quem também nos ajudará a contar essa história também é Ana Rosa de Paula (in memorian), nossa antiga sacristã, que deixou documento escrito também se recordando da época. “Assim foi que, no ano de 1956 três pessoas iluminadas pelo Divino Espírito Santo resolveram construir uma Igreja no Bairro de Vila Nova Jaú e Vila Sampaio[...]: o Sr. Onofre Ananias de Paula, o Sr. Angelo José Pascoalotte e o Sr. Laurindo Del Cazalli”, comenta Ana Paula.</p>

        <p className='text-justify mb-[30px]'>Segundo a antiga sacristã, a ideia da construção partiu após um encontro dos três doadores em um empório localizado na avenida no dia 26 de novembro de 1956 e se depararam com um mendigo embriagado, conhecido como ‘Dito Cachaça’ e sofria com alguns garotos do bairro que lhe insultavam e até atiravam pedras nele.</p>

        <p className='text-justify mb-[30px]'>“Diante dessa atitude, houve a interferência dos Srs. Onofre, Angelo e Laurindo, que impediram a ação desses garotos. Mediante ao ocorrido, os três amigos questionaram que alguma providência para impedir essas atitudes deveria ser tomada, ou a instalação de um posto policial, como sugeriu o Sr. Angelo, ou então, segundo o Sr. Onofre, que era uma pessoa bastante religiosa, a construção de uma igreja para a evangelização do bairro e, principalmente, desses garotos”, lembra Ana Paula em seu documento.</p>

        <p className='text-justify mb-[30px]'>Então os três doadores foram a um bar e colocaram as suas ideias sobre uma igreja no bairro. O dono do bar em que houve a reunião, senhor Alcides Nunes, ofereceu um salão de sua propriedade, anexo ao bar, para a construção.</p>
        ...
        <h2 className='text-2xl font-bold uppercase mb-[10px]'>O Sentimento</h2>

        <p className='text-justify mb-[30px]'>“A Igreja é isso: o trabalho de uma comunidade que viu a necessidade da Palavra de Deus perto da sua casa e se empenhou para fazer o melhor para que isso acontecesse”, lembra emocionado o Diácono Francisco Trofino.</p>

        <p className='text-justify mb-[30px]'>E hoje a nossa comunidade continua e você que nos lê e participa de nossas celebrações. Obrigado por fazer parte dessa história.</p>
