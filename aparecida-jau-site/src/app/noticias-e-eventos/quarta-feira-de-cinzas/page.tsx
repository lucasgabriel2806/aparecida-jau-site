...
export default function QuartaFeiraCinzas() {
  ...
  return (
    ...
    >
      ...
      <h1 className='text-2xl font-bold uppercase'>História da Paróquia</h1>
      ...
      <p className='text-justify'>“Diante dessa atitude, houve a interferência dos Srs. Onofre, Angelo e Laurindo, que impediram a ação desses garotos. Mediante ao ocorrido, os três amigos questionaram que alguma providência para impedir essas atitudes deveria ser tomada, ou a instalação de um posto policial, como sugeriu o Sr. Angelo, ou então, segundo o Sr. Onofre, que era uma pessoa bastante religiosa, a construção de uma igreja para a evangelização do bairro e, principalmente, desses garotos”, lembra Ana Paula em seu documento.</p>

      <p className='text-justify'>Então os três doadores foram a um bar e colocaram as suas ideias sobre uma igreja no bairro. O dono do bar em que houve a reunião, senhor Alcides Nunes, ofereceu um salão de sua propriedade, anexo ao bar, para a construção.</p>
      ...
      <p className='text-justify'>Já com a pedra fundamental e a futura padroeira no local da igreja é hora de construir o templo.</p>
      ...
      <p className='text-justify'>“A Igreja é isso: o trabalho de uma comunidade que viu a necessidade da Palavra de Deus perto da sua casa e se empenhou para fazer o melhor para que isso acontecesse”, lembra emocionado o Diácono Francisco Trofino.</p>

      <p className='text-justify'>E hoje a nossa comunidade continua e você que nos lê e participa de nossas celebrações. Obrigado por fazer parte dessa história.</p>
